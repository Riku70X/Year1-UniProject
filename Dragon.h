...
public:
	...
	short getAttackDamage(); // Replaces the enemy function of the same name, since the Dragon will sometimes use an attack turn to instea heal itself. It will do this up to once per fight.
